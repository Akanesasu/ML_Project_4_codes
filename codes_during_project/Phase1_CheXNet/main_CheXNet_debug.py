...
class CheXNet(Backbone):
	...
	def __init__(self, cfg=None, input_shape=None):
		...
		if os.path.isfile(PRE_TRAINED_CKPT_PATH):
			...
			# TODO: change on server the following line to use GPU
	...
	def forward(self, image):
		...
		return {"features": self.features(image)}
...
if __name__ == '__main__':
	...
	# we have only 1 GPU, so it will see 8 images per batch.
