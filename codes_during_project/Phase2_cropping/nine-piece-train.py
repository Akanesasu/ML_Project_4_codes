...
def recombine(crop_outputs, input):
    ...
    for outset_h in OUTSET_Hs:
        for outset_w in OUTSET_Ws:
            ...
            # add offset
            crop_boxes = crop_instances.pred_boxes.tensor + torch.tensor([top, left, top, left])
...
if __name__ == '__main__':
    ...
    # anchor size according to bbox size when short side = 2700
    ...
    cfg.INPUT.CROP.SIZE = [0.25, 0.25]
    cfg.INPUT.MIN_SIZE_TRAIN = (675, ) # 2700 * 0.25 
    cfg.INPUT.MAX_SIZE_TRAIN = 1050
    cfg.INPUT.MIN_SIZE_TEST = 2700
    cfg.INPUT.MAX_SIZE_TEST = 4050
